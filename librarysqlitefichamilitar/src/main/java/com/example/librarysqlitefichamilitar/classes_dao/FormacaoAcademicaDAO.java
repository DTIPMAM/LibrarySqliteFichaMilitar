...
public class FormacaoAcademicaDAO {
    ...
    private Context ctx;
    private String table_name = "pessoas_formacao_academica";
    private String[] colunas = new String[]{"_id", "id_pessoa", "area", "nome_curso", "instituicao", "finl", "carga_horaria", "completo"};
