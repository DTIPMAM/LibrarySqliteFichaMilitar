...
import com.example.librarysqlitefichamilitar.classes_vo.DispensasMedicasVO;
...
public class DispensasMedicasDAO {
    ...
    public boolean insert(DispensasMedicasVO vo) {
    ...
    public boolean update(DispensasMedicasVO vo , String cod) {
