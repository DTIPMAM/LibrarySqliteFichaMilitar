...
import com.example.librarysqlitefichamilitar.classes_vo.MedalhasCondecoracoesVO;
...
public class MedalhasCondecoracoesDAO {

    private final Context ctx;
    private final String table_name = "pessoas_medalhas_condecoracoes";
    private final String[] colunas    = new String[]{"_id","id_pessoa","medalhaCondecoracao","data_condecoracao","data_boletim","numero_boletim"};

    public MedalhasCondecoracoesDAO(Context ctx) {
        this.ctx = ctx;
    }

    public boolean insert(MedalhasCondecoracoesVO vo) {
        ...
        values.put("medalhaCondecoracao",vo.getMedalhaCondecoracao());
        values.put("data_condecoracao",vo.getData_condecoracao());
    ...
    public boolean update(MedalhasCondecoracoesVO vo , String cod) {
        ...
        if(db.update(table_name, values, "_id = ?", new String[]{cod}) > 0){
            db.close();
          //  //Log.d("Updateid_militar", String.valueOf(vo.getId_pessoa()));
            return true;
        }else{
            return false;
        } }
    ...
    public boolean VerificaSeTemIdBD_Local ( String codescala) {
        ...
        //não fazer log.i somente log.d // causa erro fatal quando objeto null
