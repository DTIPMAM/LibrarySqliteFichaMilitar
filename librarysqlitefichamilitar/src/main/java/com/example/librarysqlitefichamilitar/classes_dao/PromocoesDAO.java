...
public class PromocoesDAO {
    ...
    private Context ctx;
    private String table_name = "pessoas_promocoes";
    private String[] colunas    = new String[]{"_id","id_pessoa","TipoPromocao","descricao_promocao","data_boletim","numero_boletim"};
