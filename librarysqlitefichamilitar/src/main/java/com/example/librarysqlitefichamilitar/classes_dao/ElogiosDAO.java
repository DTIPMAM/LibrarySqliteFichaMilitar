...
public class ElogiosDAO {
    ...
    private Context ctx;
    private String table_name = "pessoas_elogios";
    private String[] colunas = new String[]{"_id", "id_pessoa", "data_elogio", "descricao_elogio", "nome_autoridade", "data_boletim", "numero_boletim"};
